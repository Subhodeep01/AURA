...
def classify_video_gpt4o(video_path, classes, max_retries=3):
    """
...
def process_all_videos(video_dir='sampled_videos', output_csv='gpt-5-mini_predictions.csv'):
    """
    ...
    with open(output_csv, 'w', newline='', encoding='utf-8') as csvfile:
        ...
        for idx, video_file in enumerate(video_files, 1):
            ...
            # Classify video
            predicted_class = classify_video_gpt4o(video_path, CLASSES)
